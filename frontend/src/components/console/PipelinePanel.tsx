...
const EVENT_TO_STAGE: Record<string, { stage: string; state: StageState }> = {
  ...
  SpeechSegmentCreated: { stage: "VAD", state: "success" },
  SpeechSegmentReceived: { stage: "Speech Segment", state: "success" },
  SpeechTranscribing: { stage: "Whisper", state: "running" },
  SpeechRecognized: { stage: "Whisper", state: "success" },
  SpeechTranscribed: { stage: "Whisper", state: "success" },
  ReferenceDetected: { stage: "Intenção", state: "success" },
  ReferenceInvalid: { stage: "Intenção", state: "warning" },
  IntentUnknown: { stage: "Intenção", state: "idle" },
